...
# Ashutosh changing the jobs from 50 to 30 :
n_jobs = 12
#n_jobs = -2
...
if model_type == 'LR':
    clf = RandomizedSearchCV(
        # Ashutosh commented to add N-jobs , max_iter and verbose : 
        LogisticRegression(solver='lbfgs', n_jobs = 50), 
...
try:
    joblib.dump(clf, 'output/outcome={},T={},dt={}/{}.joblib'.format(task, T, dt, model_name))
    np.savetxt(
